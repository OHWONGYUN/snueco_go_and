...
import 'personal_policy_model.dart';
export 'personal_policy_model.dart';

class PersonalPolicyWidget extends StatefulWidget {
  const PersonalPolicyWidget({super.key});

  @override
  State<PersonalPolicyWidget> createState() => _PersonalPolicyWidgetState();
}

class _PersonalPolicyWidgetState extends State<PersonalPolicyWidget> {
  late PersonalPolicyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PersonalPolicyModel());
  }
